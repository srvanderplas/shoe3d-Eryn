...
rotattionmat1<-rbind(cbind(t(sony2pca$rotation), c(0, 0, 0)), c(0, 0, 0, 1))
```

```{r}
#FIND A CENTERING??
sony1tran<-transform3d(sony1, matrix = rotationMatrix(matrix = diag(c(-1,1,1)) %*% sony1pca$rotation))
