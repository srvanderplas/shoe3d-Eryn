# Getting help with shoe3d

Thanks for using shoe3d. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/shoe3d/issues) to make sure the 
